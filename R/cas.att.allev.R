cas.att.allev <- function(net_obj, dt){
  ...
  names(df)<-c( "cas.att.allev.vertex", "cas.att.allev.value", "cas.att.allev.number.of.vertices", "cas.att.allev.maxcsize", "cas.att.allev.cohesion", "cas.allev.deg.averagepath", "cas.att.allev.adhesion", "cas.att.allev.edgedensity", "cas.att.allev.transitivity", "cas.att.allev.radius", "cas.att.allev.density", "cas.att.allev.centralization", "cas.att.allev.components")
  return(df)
}
